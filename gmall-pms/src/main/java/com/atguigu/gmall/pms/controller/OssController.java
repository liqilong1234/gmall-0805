...
public class OssController {
    ...
    public Resp<Object> oss(){
        String accessId = "LTAI4Frm3MLtK7k7bSpBHJCp"; // 请填写您的AccessKeyId。
        String accessKey = "55u5QrS3bIS1fvkCqcyRimO5LnCLqa"; // 请填写您的AccessKeySecret。
        String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
        String bucket = "gulidemo0715"; // 请填写您的 bucketname 。
